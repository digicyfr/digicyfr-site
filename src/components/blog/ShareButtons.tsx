...
import '@/styles/components/blog/share-buttons.css';
  ...
  return (
    <div className="share-buttons">
      <div className="share-buttons-container">
        <h3 className="share-buttons-title">
          {shareText[locale as keyof typeof shareText]}
        </h3>
