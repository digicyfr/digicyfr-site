...
const clients = [
  ...
  { 
    ...
    emoji: "🌊",
    industry: "Services d'import-export",
...
const stats = [
  ...
  { number: "20+", label: "Solutions d'entreprise" },
  { number: "100%", label: "Taux de réussite" },
  { number: "50%", label: "Meilleurs prix" }
];
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 1rem' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
          ...
          <p style={{
            ...
            Les entreprises qui font confiance à Digicyfr pour booster leur présence en ligne et leurs ventes
          </p>
        </div>
